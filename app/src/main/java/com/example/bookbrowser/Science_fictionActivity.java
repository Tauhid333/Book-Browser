...
public class Science_fictionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BooksRef = FirebaseDatabase.getInstance().getReference().child("Books").child("Science Fiction");
                    ...
                    protected void onBindViewHolder(@NonNull BooksViewHolder holder, int position, @NonNull final Books model)
                    {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener()
                        {
                            ...
                            public void onClick(View v)
                            {
                                ...
                                Intent intent = new Intent(Science_fictionActivity.this, BookDetailsActivity.class);

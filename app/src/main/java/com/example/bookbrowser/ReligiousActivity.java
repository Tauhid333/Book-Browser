...
public class ReligiousActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BooksRef = FirebaseDatabase.getInstance().getReference().child("Books").child("Religious");
                    ...
                    protected void onBindViewHolder(@NonNull BooksViewHolder holder, int position, @NonNull final Books model)
                    {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener()
                        {
                            ...
                            public void onClick(View v)
                            {
                                ...
                                Intent intent = new Intent(ReligiousActivity.this, BookDetailsActivity.class);

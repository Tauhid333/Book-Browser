...
public class AdminUsersOrdersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_users_orders);



        userID = getIntent().getStringExtra("uid");

        productsList = findViewById(R.id.book_list);
        ...
        cartListRef = FirebaseDatabase.getInstance().getReference()
                .child("Cart List").child("Admin View").child(userID).child("Books");

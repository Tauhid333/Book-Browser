...
public class BiopicActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_biopic);
        ...
        BooksRef = FirebaseDatabase.getInstance().getReference().child("Books").child("Biopic");
                    ...
                    protected void onBindViewHolder(@NonNull BooksViewHolder holder, int position, @NonNull final Books model)
                    {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener()
                        {
                            ...
                            public void onClick(View v)
                            {
                                    ...
                                    Intent intent = new Intent(BiopicActivity.this, BookDetailsActivity.class);
